    ...
    <div className="min-h-screen bg-space-black">
      ...
      <section className="relative h-[calc(100vh-3.5rem)] mt-14 overflow-hidden">
        ...
        <button
          ...
          className="absolute bottom-8 right-6 flex items-center gap-2 px-4 py-2.5 glass rounded-lg border border-purple-400/30 text-purple-400 hover:bg-purple-400/10 transition-colors text-xs tracking-wider"
        >
          <Sparkles size={13} />
